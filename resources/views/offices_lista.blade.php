...
<html lang="en">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            ...
            @endphp
              @if($ciudad_seo != "")
                 <a href="https://socasesores.com/oficinas/{{ str_replace(' ','-',strtolower($hipoteca->estado)).'/'.str_replace(' ','-',strtolower($ciudad_seo)).'/'.$hipoteca->url_clean }}">https://socasesores.com/oficinas/{{ str_replace(' ','-',strtolower($hipoteca->estado)).'/'.str_replace(' ','-',strtolower($ciudad_seo)).'/'.$hipoteca->url_clean }}</a><br>
              @endif
            @endforeach
          </div>
        </div>
  ...
  <div class="tab-content" id="myTabContent">
    ...
    @endphp
      @if($ciudad_seo != "")
         <a href="https://socasesores.com/oficinas/{{ str_replace(' ','-',strtolower($empresa->estado)).'/'.str_replace(' ','-',strtolower($ciudad_seo)).'/'.$empresa->url_clean }}">https://socasesores.com/oficinas/{{ str_replace(' ','-',strtolower($empresa->estado)).'/'.str_replace(' ','-',strtolower($ciudad_seo)).'/'.$empresa->url_clean }}</a><br>
      @endif
    @endforeach
    </div>
    ...
    @endphp
      @if($ciudad_seo != "")
         <a href="https://socasesores.com/oficinas/{{ str_replace(' ','-',strtolower($seguro->estado)).'/'.str_replace(' ','-',strtolower($ciudad_seo)).'/'.$seguro->url_clean }}">https://socasesores.com/oficinas/{{ str_replace(' ','-',strtolower($seguro->estado)).'/'.str_replace(' ','-',strtolower($ciudad_seo)).'/'.$seguro->url_clean }}</a><br>
      @endif
    @endforeach
    </div>
  </div> 
